  ...
  return (
    <div className="space-y-16">
      ...
      <section className="space-y-12">
        ...
        <div className="flex text-xl items-center gap-5">
          ...
          <Link
            ...
            className="underline px-1 py-1 hover:opacity-80 hover:cursor-pointer transition"
          >
            {t("See examples")}
          </Link>
          <Link
      ...
      <section className="space-y-6" id="section-what-i-build">
        <h2 className="text-2xl font-semibold">{t("What I build")}</h2>
      ...
      <section className="space-y-6">
        ...
        <p className="text-text-lighter">
          {t("Tell me about your workflow and I’ll suggest the best approach.")}
        </p>
